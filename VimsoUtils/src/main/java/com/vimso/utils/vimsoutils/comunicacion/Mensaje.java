...
/**
 * Clase para encampsular los mensajes que se muestran al usuario, 
 * para su internalización y parametrización
 * @author vimso
 */
...
//</editor-fold>
    ...
    public boolean equals(Object o) {
        ...
        if (parametros!=null & mensajeExterno.getParametros()!=null && !mensajeExterno.getParametros().equals(parametros)) {
            return false;
        }
    ...
    public int hashCode() {
        int hash = 7;
        hash = 83 * hash + (this.claveMensaje != null ? this.claveMensaje.hashCode() : 0);
        hash = 83 * hash + (this.parametros != null ? this.parametros.hashCode() : 0);
        return hash;
    }
